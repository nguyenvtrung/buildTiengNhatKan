...
`,et=l.forwardRef(function(t,o){const i=ee({props:t,name:"MuiTouchRipple"}),{center:n=!1,classes:s={},className:r,...p}=i,[u,d]=l.useState([]),f=l.useRef(0),h=l.useRef(null);l.useEffect(()=>{h.current&&(h.current(),h.current=null)},[u]);const M=l.useRef(!1),B=Le(),x=l.useRef(null),w=l.useRef(null),T=l.useCallback(c=>{const{pulsate:C,rippleX:y,rippleY:m,rippleSize:S,cb:L}=c;d(j=>[...j,b.jsx(Ze,{classes:{ripple:P(s.ripple,E.ripple),rippleVisible:P(s.rippleVisible,E.rippleVisible),ripplePulsate:P(s.ripplePulsate,E.ripplePulsate),child:P(s.child,E.child),childLeaving:P(s.childLeaving,E.childLeaving),childPulsate:P(s.childPulsate,E.childPulsate)},timeout:Q,pulsate:C,rippleX:y,rippleY:m,rippleSize:S},f.current)]),f.current+=1,h.current=L},[s]),R=l.useCallback((c={},C={},y=()=>{})=>{const{pulsate:m=!1,center:S=n||C.pulsate,fakeElement:L=!1}=C;if((c==null?void 0:c.type)==="mousedown"&&M.current){M.current=!1;return}(c==null?void 0:c.type)==="touchstart"&&(M.current=!0);const j=L?null:w.current,$=j?j.getBoundingClientRect():{width:0,height:0,left:0,top:0};let D,k,N;if(S||c===void 0||c.clientX===0&&c.clientY===0||!c.clientX&&!c.touches)D=Math.round($.width/2),k=Math.round($.height/2);else{const{clientX:O,clientY:U}=c.touches&&c.touches.length>0?c.touches[0]:c;D=Math.round(O-$.left),k=Math.round(U-$.top)}if(S)N=Math.sqrt((2*$.width**2+$.height**2)/3),N%2===0&&(N+=1);else{const O=Math.max(Math.abs((j?j.clientWidth:0)-D),D)*2+2,U=Math.max(Math.abs((j?j.clientHeight:0)-k),k)*2+2;N=Math.sqrt(O**2+U**2)}c!=null&&c.touches?x.current===null&&(x.current=()=>{T({pulsate:m,rippleX:D,rippleY:k,rippleSize:N,cb:y})},B.start(qe,()=>{x.current&&(x.current(),x.current=null)})):T({pulsate:m,rippleX:D,rippleY:k,rippleSize:N,cb:y})},[n,T,B]),v=l.useCallback(()=>{R({},{pulsate:!0})},[R]),I=l.useCallback((c,C)=>{if(B.clear(),(c==null?void 0:c.type)==="touchend"&&x.current){x.current(),x.current=null,B.start(0,()=>{I(c,C)});return}x.current=null,d(y=>y.length>0?y.slice(1):y),h.current=C},[B]);return l.useImperativeHandle(o,()=>({pulsate:v,start:R,stop:I}),[v,R,I]),b.jsx(Qe,{className:P(E.root,s.root,r),ref:w,...p,children:b.jsx(ne,{component:null,exit:!0,children:u})})});function tt(e){return ce("MuiButtonBase",e)}const ot=Z("MuiButtonBase",["root","disabled","focusVisible"]),nt=e=>{const{disabled:t,focusVisible:o,focusVisibleClassName:i,classes:n}=e,r=pe({root:["root",t&&"disabled",o&&"focusVisible"]},tt,n);return o&&i&&(r.root+=` ${i}`),r},st=z("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(e,t)=>t.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${ot.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),rt=l.forwardRef(function(t,o){const i=ee({props:t,name:"MuiButtonBase"}),{action:n,centerRipple:s=!1,children:r,className:p,component:u="button",disabled:d=!1,disableRipple:f=!1,disableTouchRipple:h=!1,focusRipple:M=!1,focusVisibleClassName:B,LinkComponent:x="a",onBlur:w,onClick:T,onContextMenu:R,onDragLeave:v,onFocus:I,onFocusVisible:c,onKeyDown:C,onKeyUp:y,onMouseDown:m,onMouseLeave:S,onMouseUp:L,onTouchEnd:j,onTouchMove:$,onTouchStart:D,tabIndex:k=0,TouchRippleProps:N,touchRippleRef:O,type:U,...H}=i,W=l.useRef(null),g=Xe(),de=ae(g.ref,O),[F,Y]=l.useState(!1);d&&F&&Y(!1),l.useImperativeHandle(n,()=>({focusVisible:()=>{Y(!0),W.current.focus()}}),[]);const fe=g.shouldMount&&!f&&!d;l.useEffect(()=>{F&&M&&!f&&g.pulsate()},[f,M,F,g]);const he=V(g,"start",m,h),me=V(g,"stop",R,h),ge=V(g,"stop",v,h),be=V(g,"stop",L,h),Me=V(g,"stop",a=>{F&&a.preventDefault(),S&&S(a)},h),xe=V(g,"start",D,h),ye=V(g,"stop",j,h),Re=V(g,"stop",$,h),Ce=V(g,"stop",a=>{le(a.target)||Y(!1),w&&w(a)},!1),Ee=G(a=>{W.current||(W.current=a.currentTarget),le(a.target)&&(Y(!0),c&&c(a)),I&&I(a)}),J=()=>{const a=W.current;return u&&u!=="button"&&!(a.tagName==="A"&&a.href)},Be=G(a=>{M&&!a.repeat&&F&&a.key===" "&&g.stop(a,()=>{g.start(a)}),a.target===a.currentTarget&&J()&&a.key===" "&&a.preventDefault(),C&&C(a),a.target===a.currentTarget&&J()&&a.key==="Enter"&&!d&&(a.preventDefault(),T&&T(a))}),Te=G(a=>{M&&a.key===" "&&F&&!a.defaultPrevented&&g.stop(a,()=>{g.pulsate(a)}),y&&y(a),T&&a.target===a.currentTarget&&J()&&a.key===" "&&!a.defaultPrevented&&T(a)});let K=u;K==="button"&&(H.href||H.to)&&(K=x);const X={};K==="button"?(X.type=U===void 0?"button":U,X.disabled=d):(!H.href&&!H.to&&(X.role="button"),d&&(X["aria-disabled"]=d));const Se=ae(o,W),se={...i,centerRipple:s,component:u,disabled:d,disableRipple:f,disableTouchRipple:h,focusRipple:M,tabIndex:k,focusVisible:F},Pe=nt(se);return b.jsxs(st,{as:K,className:P(Pe.root,p),ownerState:se,onBlur:Ce,onClick:T,onContextMenu:me,onFocus:Ee,onKeyDown:Be,onKeyUp:Te,onMouseDown:he,onMouseLeave:Me,onMouseUp:be,onDragLeave:ge,onTouchEnd:ye,onTouchMove:Re,onTouchStart:xe,ref:Se,tabIndex:d?-1:k,type:U,...X,...H,children:[r,fe?b.jsx(et,{ref:de,center:s,...N}):null]})});function V(e,t,o,i=!1){return G(n=>(o&&o(n),i||e[t](n),!0))}const it=$e(b.jsx("path",{d:"M6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"}),"MoreHoriz"),at=z(rt)(De(({theme:e})=>({display:"flex",marginLeft:`calc(${e.spacing(1)} * 0.5)`,marginRight:`calc(${e.spacing(1)} * 0.5)`,...e.palette.mode==="light"?{backgroundColor:e.palette.grey[100],color:e.palette.grey[700]}:{backgroundColor:e.palette.grey[700],color:e.palette.grey[100]},borderRadius:2,"&:hover, &:focus":{...e.palette.mode==="light"?{backgroundColor:e.palette.grey[200]}:{backgroundColor:e.palette.grey[600]}},"&:active":{boxShadow:e.shadows[0],...e.palette.mode==="light"?{backgroundColor:ue(e.palette.grey[200],.12)}:{backgroundColor:ue(e.palette.grey[600],.12)}}}))),lt=z(it)({width:24,height:16});function ut(e){const{slots:t={},slotProps:o={},...i}=e,n=e;return b.jsx("li",{children:b.jsx(at,{focusRipple:!0,...i,ownerState:n,children:b.jsx(lt,{as:t.CollapsedIcon,ownerState:n,...o.collapsedIcon})})})}function ct(e){return ce("MuiBreadcrumbs",e)}const pt=Z("MuiBreadcrumbs",["root","ol","li","separator"]),dt=e=>{const{classes:t}=e;return pe({root:["root"],li:["li"],ol:["ol"],separator:["separator"]},ct,t)},ft=z(ze,{name:"MuiBreadcrumbs",slot:"Root",overridesResolver:(e,t)=>[{[`& .${pt.li}`]:t.li},t.root]})({}),ht=z("ol",{name:"MuiBreadcrumbs",slot:"Ol",overridesResolver:(e,t)=>t.ol})({display:"flex",flexWrap:"wrap",alignItems:"center",padding:0,margin:0,listStyle:"none"}),mt=z("li",{name:"MuiBreadcrumbs",slot:"Separator",overridesResolver:(e,t)=>t.separator})({display:"flex",userSelect:"none",marginLeft:8,marginRight:8});function gt(e,t,o,i){return e.reduce((n,s,r)=>(r<e.length-1?n=n.concat(s,b.jsx(mt,{"aria-hidden":!0,className:t,ownerState:i,children:o},`separator-${r}`)):n.push(s),n),[])}const xt=l.forwardRef(function(t,o){const i=ee({props:t,name:"MuiBreadcrumbs"}),{children:n,className:s,component:r="nav",slots:p={},slotProps:u={},expandText:d="Show path",itemsAfterCollapse:f=1,itemsBeforeCollapse:h=1,maxItems:M=8,separator:B="/",...x}=i,[w,T]=l.useState(!1),R={...i,component:r,expanded:w,expandText:d,itemsAfterCollapse:f,itemsBeforeCollapse:h,maxItems:M,separator:B},v=dt(R),I=Ne({elementType:p.CollapsedIcon,externalSlotProps:u.collapsedIcon,ownerState:R}),c=l.useRef(null),C=m=>{const S=()=>{T(!0);const L=c.current.querySelector("a[href],button,[tabindex]");L&&L.focus()};return h+f>=m.length?m:[...m.slice(0,h),b.jsx(ut,{"aria-label":d,slots:{CollapsedIcon:p.CollapsedIcon},slotProps:{collapsedIcon:I},onClick:S},"ellipsis"),...m.slice(m.length-f,m.length)]},y=l.Children.toArray(n).filter(m=>l.isValidElement(m)).map((m,S)=>b.jsx("li",{className:v.li,children:m},`child-${S}`));return b.jsx(ft,{ref:o,component:r,color:"textSecondary",className:P(v.root,s),ownerState:R,...x,children:b.jsx(ht,{className:v.ol,ref:c,ownerState:R,children:gt(w||M&&y.length<=M?y:C(y),v.separator,B,R)})})});export{xt as B,rt as a};
